{
  perSystem =
    ...
    let
      xivlauncher-rb = pkgs.callPackage (
        {
          lib,
          buildDotnetModule,
          fetchFromGitHub,
        ...
        buildDotnetModule rec {
          ...
          nugetDeps = ./xivlauncher-rb-deps.json; # File generated with `nix-build -A xivlauncher.passthru.fetch-deps`
    ...
    in
    lib.optionalAttrs (system == "x86_64-linux") { packages.xivlauncher-rb = xivlauncher-rb; };
}
